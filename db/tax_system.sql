...
INSERT INTO `complaints` VALUES (1,1,'dsaf','2019-05-18 15:07:02',NULL),(2,1,'sadfsadf','2019-05-18 15:21:35',NULL),(3,1,'dsafasfsafdasfsa123asdfsafsafsafdasfdasfsdafs','2019-05-19 05:37:24',NULL),(4,13,'he is bad guy','2019-06-01 08:06:00',NULL);
...
INSERT INTO `persons` VALUES (-1,'test','test','test','1',1,1,NULL),(1,'ADMIN','ADMIN','admin@gmail.com','1',1,1,NULL),(2,'John','Snow','aegon_tg@gmail.com','1',2,1,NULL),(11,'Max','Nesterchuk','max@gmail.com','1',1,1,NULL),(12,'Katryn','Petrova','kd@gmail.com','1',1,1,NULL),(13,'Administrator','Admin','a@g.c','1',1,1,NULL),(14,'Client','Cl','c@g.c','1',2,1,NULL),(15,'Client1','cl1','c1@g.c','1',2,1,NULL),(16,'Client2','cl2','c2@g.c','1',2,1,NULL),(17,'Client3','CL3','c3@g.c','1',2,13,NULL);
...
INSERT INTO `persons_has_taxable_items` VALUES (-1,1),(1,1),(2,1),(14,1),(15,1),(17,1),(1,2),(2,2),(14,2),(15,2),(17,2),(2,3),(14,3),(17,3);
...
INSERT INTO `reports` VALUES (1,2,'AASSFSAF','1123123123','2019-05-18 13:09:26',1,1,0,'asdf',NULL),(4,2,'DOX123123','123213','2019-05-19 05:38:24',0,1,0,'лд',NULL),(7,2,'asfdsaf','12313','2019-05-19 06:01:28',1365,1,1,'sdfsdfa',NULL),(9,2,'asfdsaf','123','2019-05-19 06:02:58',1365,0,1,'123123',NULL),(11,2,'DOX123123','123','2019-05-19 06:03:27',1365,0,0,'asdf        asdfasfd                        ',NULL),(12,17,'COMP3','33333','2019-05-30 18:49:50',12690,1,1,'comm3',NULL),(13,17,'epam','1234567890','2019-06-01 08:05:07',12690,1,1,'das ist Gut',NULL),(14,14,'ep','12323324','2019-06-02 19:09:08',57,0,0,NULL,NULL);
...
INSERT INTO `taxable_items` VALUES (1,'square meter office space tax',9,NULL),(2,'employee tax',15,NULL),(3,'per one million income tax',33,NULL);
/*!40000 ALTER TABLE `taxable_items` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database ' tax_system'
--

--
-- Dumping routines for database ' tax_system'
--
...
-- Dump completed on 2019-07-23 23:34:21
